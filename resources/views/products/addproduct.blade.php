...
<?php
 ...
 ?>
                ...
                <div class="form-group"><label class="col-lg-2 control-label" >Price</label>
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('price', null, array('placeholder' => '23.00','class' => 'form-control','required' => '','data-parsley-type' => 'number','data-parsley-trigger' => 'keyup','data-parsley-pattern'=>"^[0-8]*\.[0-9]{2}$")) !!}
