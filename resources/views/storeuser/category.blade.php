        ...
        <div class="ibox-content">
           ...
           <form method="POST" id="Catogoryadd" class="form-horizontal" action="{{ url('addcategory')}}">
            ...
            <div class="form-group"><label class="col-lg-2 control-label">Name</label>
                ...
                <div class="col-lg-8">   {!! Form::text('categoryname', null, array('placeholder' => 'Name','class' => 'form-control','data-parsley-trigger'=>'keyup','data-parsley-pattern'=>'^[a-zA-Z0-9 ]*$','data-parsley-minlength'=>'3','required' => '')) !!} <span
