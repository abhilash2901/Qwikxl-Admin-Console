                ...
                <div class="ibox-content">
                    ...
                    <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15" ng-init="listingassignedOrder('2')">
                        ...
                        <tr dir-paginate=" new in getassingedOrders | filter:orderid | filter:customerphone | itemsPerPage:10">
                            ...
                            <td class="text-right">
                                <div class="btn-group">
								    {{ Form::open(array('url' => 'viewassignedorder','class' => 'pull-left')) }}<input type="hidden" name="id" value="@{{new.order_id}}"><input type="hidden" name="status" value="assaigned"> <input type="submit" class="btn btn-primary btn-sm" value="View Order"></form>
