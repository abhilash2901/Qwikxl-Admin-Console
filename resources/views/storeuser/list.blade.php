...
<div class="wrapper wrapper-content animated fadeInRight" >
    ...
    data-parsley-type="number"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" data-parsley-trigger="keyup" data-parsley-pattern='^(\([0-9]{3}\) |[0-9]{3}-)[0-9]{3}-[0-9]{4}$' required placeholder="" name="phone" id="phone" value="@{{detailsstores.phone}}" >
						       ...
						       <div class="uploadsucess" tabindex="1"></div>
								<div class="">
									<form role="form" class="form-horizontal ng-pristine ng-valid" id="addbanner" method="POST" action="{{ url('savebanner')}}">
										...
										<div class="form-group">
											<div class="col-sm-8">
											   <button type="submit" class="btn btn-primary pull-right " ng-hide="isDisabled==true" ng-click="AddBanner()">Add New Banner</button>
