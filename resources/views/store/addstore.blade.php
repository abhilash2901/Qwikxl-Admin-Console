...
<!--                             <input type='button' class="btn btn-primary" value='save' id='save'>-->
    ...
    data-parsley-type="number"></div>
                            ...
                            <div class="col-md-4"><div class="input-group clockpicker" data-autoclose="true">
                                <input type="text" class="form-control" name="closing_time" readonly>
                                <span class="input-group-addon">
                                    <span class="fa fa-clock-o"></span>
                                </span>
                            </div></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" data-parsley-trigger="keyup" data-parsley-pattern='^(\([0-9]{3}\) |[0-9]{3}-)[0-9]{3}-[0-9]{4}$' required  placeholder="" name="phone" >
